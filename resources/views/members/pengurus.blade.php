...
@section('member')
    ...
    <div
        class="max-w-4xl flex flex-col md:justify-center md:flex-row text-center mx-auto space-y-2 md:space-y-0 md:space-x-2">
        <div class="shadow-xl border-[#10758F] rounded-2xl">
            <div class="w-fit h-fit mx-auto p-5">
                <img class="w-52 h-52" src="{{ asset('/images/GenBIUnsulbar.png') }}" alt="profile">
            </div>
    ...
    <div
        class="max-w-4xl flex flex-col md:justify-center md:flex-row text-center mx-auto space-y-2 md:space-y-0 md:space-x-2 flex-wrap">
        <div class="shadow-xl border-[#10758F] rounded-2xl">
            <div class="w-fit h-fit mx-auto p-5">
                <img class="w-52 h-52" src="{{ asset('/images/GenBIUnsulbar.png') }}" alt="profile">
            </div>
