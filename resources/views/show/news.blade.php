...
@section('content')
    <div class="pt-24 text-center px-10">
        <h1 class="max-w-3xl mx-auto text-2xl md:text-4xl text-gray-800 font-semibold mt-5 mb-2 md:mt-10 md:mb-4">GenBI Unsulbar Melaksanakan Program Kerja GenBI Mengajar</h1>
